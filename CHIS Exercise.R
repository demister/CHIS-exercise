...
##Exercise 2: Answer is There is an unexpectedly large number of very old people.

## Exercise 3:If you don't specify the binwidth argument inside geom_histogram() 
##you can tell from the message that 30 bins are used by default. This will then 
##specify the binwidth that is used. What is this binwidth for the age variable, 
##SRAGE_P, of the adult dataset?
## 2.23
...
## Use the adult$RBMI (corresponding to FILL) and adult$SRAGE_P (corresponding to X) columns inside the table()
